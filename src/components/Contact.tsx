      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 animate-fade-in">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            ...
            your project and receive a personalized quote tailored to your
            needs.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-16">
                ...
                <form className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <Input placeholder="+94 77 123 4567" className="h-12" />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-foreground mb-2">
                        Event Date
          ...
          <div className="space-y-6">
            {contactInfo.map((info, index) => (
              <Card
                key={info.title}
                className="shadow-elegant hover:shadow-glow transition-all duration-300 hover-lift"
              >
        ...
        <Card className="shadow-elegant">
          <CardContent className="p-0">
            <div className="relative h-96 bg-muted rounded-lg overflow-hidden">
              {/* Google Map Embed */}
              <iframe
                title="3Brother Studio Location"
